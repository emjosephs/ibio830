...
1b. Fit a linear model to the data using either lme2() or lm(). What is your estimated effect size? Does it match the effect size used in the simulations above?
...
repeatLM <- function(){
  ...
  ## return(mod3@coef[[2]]) ## use this line if you used lme2()
}
...
3a. Measuring inbreeding coefficients can be challenging and imagine that you use a cheaper genotyping method that is not very accurate. The following code will add error to your inbreeding coefficient. Run it and make a plot of the noisy coefficients and the weight of your snakes.
...
4. Bonus! Modify the code from the above examples to investigate the effects of the following experimental changes:
