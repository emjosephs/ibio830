...
#### Due by midnight before the beginning of next class on 11/10
...
a) If $X \sim \text{Pois}(\lambda)$, calculate $P(X=2 | \lambda=4)$
\
\
\
\
b) You make 2 draws from the Poisson distribution and get 2 the first time, and 3 the second time. What is the probability of this outcome f $\lambda = 4$?
