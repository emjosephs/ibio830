...
Coin flips are *________ distributed*


## Calculating likelihood

Coin flips are *binomially distributed*

## Calculating likelihood with rbinom?
```{r}
hist(rbinom(n=1000, size=100, prob=0.1), main="", xlab = 'p=0.1', xlim = c(0,100))
abline(v=46, col="red")
```

## Calculating likelihood with rbinom?
```{r}
hist(rbinom(n=1000, size=100, prob=0.2), main="", xlab = 'p=0.1', xlim = c(0,100))
abline(v=46, col="red")
```


## Calculating likelihood with dbinom!
