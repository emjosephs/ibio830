...
## Homework Review - Definitions {.build}
...
## Homework Review - Probability logic {.build}
...
## Homework Review - birthday twinsies ON MARS {.build}
\
```{r, out.width="400px",echo=FALSE,fig.align="center"}
	knitr::include_graphics("figs/martian.png")
```
...
plot(-2,-2,type='n',xlab="N",ylab="p(birthday twinsies)",main="Birthday Problem",pch=19,ylim=c(0,1),col=4,xlim=c(1,40))
