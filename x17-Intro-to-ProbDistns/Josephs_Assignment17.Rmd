...
pNoCovid = coinFlipProb(n=35, k=0, p=0.01)
...
pOneCovid = coinFlipProb(n=35, k=1, p=0.01)
...
plot(0:35, coinFlipProb(n=35, k=0:35, p=0.01),
...
plot(0:35, dbinom(0:35, size=35, prob=0.01),
     xlab = "number of infections", ylab = "probability")
