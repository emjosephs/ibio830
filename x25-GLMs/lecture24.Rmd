...
What distribution models waiting time?

Let's check out the exponential shiny demo
...
Try out Poisson regression for yourself. 
\
\
Download "GLM-class-activity.Rmd" and go through
the exercise with your breakout room.
...
modData = exp(mod@coef[1]+mydata$x*mod@coef[2])
